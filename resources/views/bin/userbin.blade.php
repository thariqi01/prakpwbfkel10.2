                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-sm-right"> 
                          <a href="{{ url('user/restore') }}"  class="btn btn-info btn-sm">
                            <i class="fa fa-plus fa-fw"></i>Restore All
                          </a>
                          <a href="{{ url('user/delete') }}"  class="btn btn-danger btn-sm">
                          ...
                          @foreach($users as $p)
                            <tr>                            
                              ...
                              <td class="text-center">                                      
                                <a href="{{ url('user/restore/'.$p->id) }}" class="btn btn-info btn-sm" title="Edit Data">                                      
                                  Restore
                                </a>                                                                                          
  ...
  <div class="modal-dialog">
    <div class="modal-content bg-danger">
      ...
      <div class="modal-footer justify-content-between">
        ...
        <a href="{{ url('user/deleteperm/'.$p->id) }}" class="btn btn-outline-light">Yes</a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
