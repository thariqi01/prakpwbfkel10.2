                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-sm-right"> 
                          <a href="{{ url('kategori/restore') }}"  class="btn btn-info btn-sm">
                            <i class="fa fa-plus fa-fw"></i>Restore All
                          </a>
                          <a href="{{ url('kategori/delete') }}"  class="btn btn-danger btn-sm">
                          ...
                          @foreach($kategori as $p)
                            <tr>                            
                              ...
                              <td class="text-center">                                      
                                <a href="{{ url('provinsi/restore/'.$p->id_kategoribencana) }}" class="btn btn-info btn-sm" title="Edit Data">                                      
                                  Restore
                                </a>                                                                                          
  ...
  <div class="modal-dialog">
    <div class="modal-content bg-danger">
      ...
      <div class="modal-footer justify-content-between">
        ...
        <a href="{{ url('kategori/deleteperm/'.$p->id_kategoribencana) }}" class="btn btn-outline-light">Yes</a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
